...
async function loadRate(id) {
  ...
  while (true) {
    const res = await fetch(
      `https://shikimori.io/api/users/${user}/anime_rates?limit=${LIMIT}&page=${page}`,
      {
        headers: {
          "User-Agent": USER_AGENT
        }
...
async function loadAnime() {
    ...
    let posterUrl = POSTER_OVERRIDES[anime.id] || (anime.image?.original ? `https://shikimori.io${anime.image.original}` : null);
    ...
    document.getElementById("anime").innerHTML = `
      ...
      <div class="info">
        <div class="top-actions">
          ...
          <a class="link" href="https://shikimori.io/animes/${anime.id}" target="_blank" rel="noopener">
